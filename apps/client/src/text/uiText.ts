...
const mcp = {
  ...
  save: 'Save',
  saveBeforeTrust: 'Save the MCP config before changing trust',
  savedRestart: 'Saved. Restart server to apply MCP changes.',
  saving: 'Saving',
  serverCount: (count: number) => `${count} server${count === 1 ? '' : 's'}`,
  simpleExample: 'Simple example',
  trust: 'Trust',
  trustGranted: 'MCP server trusted',
  trusted: 'trusted',
  trustFailed: 'Failed to update MCP server trust',
  trustRevoked: 'MCP server trust revoked',
  revokeTrust: 'Revoke',
  untrusted: 'untrusted',
  validate: 'Validate',
