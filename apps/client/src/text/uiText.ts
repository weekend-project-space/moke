...
const settings = {
  ...
  confirmDiscardSettingsChanges: 'Your unsaved changes will be lost.',
...
const mcp = {
  ...
  empty: 'Add a local MCP service to get started.',
  ...
  noServerSelected: 'No MCP service selected',
  ...
  serverDetails: 'MCP service details',
  servers: 'Servers',
  serversDescription: 'Add a local MCP service to give Moke more tools.',
  stdio: 'stdio',
  timeoutHint: 'Milliseconds before the service request is stopped. Max 3,600,000.',
